...
class Read
{
     ...
     * @param integer $value Valor relacionado, geralmente o ID que se associa a outra tabela!
     ...
     *
     * @return null|array O retorno será null caso não tenha nenhum registro, ou será um array multidimensional
     */
     ...
     *
     * @return integer Quantidade de registros da consulta
     */
    ...
    /**
     * <b>setPlaces:</b> Altera os termos da Query para efetuar uma nova consulta
     *
     * @param string $parseString link={$link}&link2={$link2}
     * @return void
     */
    ...
    private function connect()
    {
        ...
        $this->consult->setFetchMode(PDO::FETCH_OBJ);
    }
